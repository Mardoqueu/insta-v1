    ...
    <div>        
        {open && (
            ...
            >
                ...
                <button disabled className='w-full bg-red-600 text-white p-2 shadow-md hover:brightness-125 disabled: bg-gray-200 disabled:cursor-not-allowed '>Upload Post</button>
                </div>
